...
<html>
	<head>
		...
		<title>Bad Ass Coffee Company</title>
	...
	<body>
		...
		<div id="header-image" data-role="header" data-theme="<?php echo $theme ?>" data-position="fixed">
		    <h1><a href="#page1"><img src="img/header_logo.jpg" alt="LOGO"></a></h1>
		</div>
		<div data-role="footer" data-theme="<?php echo $theme ?>">
			<h1>Powered by <a href="http://mobilegrows.com/">MobileGrows</a> | <a href="http://badasscoffee.com/" rel="external">Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-a"><a class="ui-btn callfind  ui-icon-phone ui-btn-icon-left buttons-radius" href="#myPopuptelephone" data-rel="popup" data-transition="flow">CALL US</a></div>
					<!-- ovdje se upisuje grad i adresa iz koje  -->
					<div class="ui-block-b" id="findUS"><a class="ui-btn callfind ui-icon-location ui-btn-icon-right buttons-radius" href="#myPopup" data-rel="popup" data-transition="flow">FIND US</a>
						<!--<script>
              ...
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">THE LEGEND</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">OUR STORES</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">ONLINE STORE</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">FRANCHISE INFO</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-alt-icon ui-btn-icon-right buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">INTERNATIONAL FRANCHISING</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo ui-alt-icon" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">THE LEGEND</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">OUR STORES</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">ONLINE STORE</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">FRANCHISE INFO</a></li>
							<li><a href="#page1" data-transition="<?php echo $transitionefect ?>">INTERNATIONAL FRANCHISING</a></li>
